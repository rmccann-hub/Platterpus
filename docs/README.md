...
| [`audit-2026-07-02.md`](audit-2026-07-02.md) | **Point-in-time full-audit record (2026-07-02):** the multi-agent code/doc review that drove the 0.4.13–0.4.16 fix batch; its §E tracks the items that were deferred (now graduated to `TASKS.md`). Candidate for `archive/` once nothing points at it as live. |
| [`trust-audit-2026-07-08.md`](trust-audit-2026-07-08.md) | **Point-in-time trust & supply-chain audit record (2026-07-08):** the seven-category audit behind the v0.4.22 hardening; confirmed-but-deferred items tracked in `TASKS.md` (its #1 signing item is still open). |
