...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-16-lap-07.md` | 20,658 | `990bb6bb7d25ee4b…` |
...
for m in PART.finditer(open("round16lap07FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-16-lap-07.md sha256=990bb6bb7d25ee4bc74004e54a84a62f565c9ceee28dc065a903f8cd93bd04b0 >>>>>>>>>>
