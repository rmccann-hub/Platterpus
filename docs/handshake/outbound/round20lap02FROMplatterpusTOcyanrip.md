...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-20-lap-02.md` | 17,483 | `84fb47ab6b160ed0…` |
...
for m in PART.finditer(open("round20lap02FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-20-lap-02.md sha256=84fb47ab6b160ed0181b65db7b0e602273f7740dec7a353aa1908a1588442ca6 >>>>>>>>>>
