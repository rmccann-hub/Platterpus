...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-26-lap-03.md` | 11,550 | `ba57e7bdbafc10bd…` |
...
for m in PART.finditer(open("round26lap03FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-26-lap-03.md sha256=ba57e7bdbafc10bd67d000572124e2faf752c23d3ced8fc13fe343f3c90be26b >>>>>>>>>>
