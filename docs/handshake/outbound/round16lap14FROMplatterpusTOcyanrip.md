...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-16-lap-14.md` | 17,199 | `2503184660c83ad0…` |
...
for m in PART.finditer(open("round16lap14FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-16-lap-14.md sha256=2503184660c83ad0f73cc3d93d6f2529f9b6464de2f2fed1e32ac0f2932fe0f2 >>>>>>>>>>
