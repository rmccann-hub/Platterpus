...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-26-lap-02.md` | 11,151 | `8485afc7f2a7b7e9…` |
...
for m in PART.finditer(open("round26lap02FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-26-lap-02.md sha256=8485afc7f2a7b7e9e7e52733a38234d8d57210c56bf16ca6181ae80620ded0ff >>>>>>>>>>
