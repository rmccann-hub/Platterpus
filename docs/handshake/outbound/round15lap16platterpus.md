...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-15-lap-16.md` | 15,459 | `32b393f458c4edec…` |
...
for m in PART.finditer(open("round15lap16platterpus.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-15-lap-16.md sha256=32b393f458c4edeca455ef10acab7fff4c55246dd8092c1a93bd9ce0a9bd1ad6 >>>>>>>>>>
