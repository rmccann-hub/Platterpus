...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-09-lap-04.md` | 18,409 | `fb25fce0b2eb6bfe…` |
...
for m in PART.finditer(open("round09platterpusenvelope.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-09-lap-04.md sha256=fb25fce0b2eb6bfe103fd505bb2c5b5329e36549842eb79f9dce13be86d95a0b >>>>>>>>>>
