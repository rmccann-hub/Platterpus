...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-22-lap-04.md` | 15,283 | `614c6115cb5a8601…` |
...
for m in PART.finditer(open("round22lap04FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-22-lap-04.md sha256=614c6115cb5a8601f746f32b579f40b3cdf717d9b542b448db71b4f7a8400e91 >>>>>>>>>>
