...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-16-lap-05.md` | 28,974 | `ad77e1346fd47218…` |
...
for m in PART.finditer(open("round16lap05FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-16-lap-05.md sha256=ad77e1346fd4721811a3415c3be0b303e732dcbe1986bb274f6e19ff4c792a98 >>>>>>>>>>
