...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-14-lap-05.md` | 14,497 | `6561d8385648c757…` |
...
for m in PART.finditer(open("round14lap05platterpus.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-14-lap-05.md sha256=6561d8385648c757d16db5588eb54b307dd40b0e9fdd08809c39ac725ea71b0b >>>>>>>>>>
