...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-27-lap-02.md` | 16,301 | `8ed9d7c2e5aaca88…` |
...
for m in PART.finditer(open("round27lap02FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-27-lap-02.md sha256=8ed9d7c2e5aaca88e510d6a3540d4df131ac4a868302e11ecfe261bcaac61ea6 >>>>>>>>>>
