...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-22-lap-02.md` | 19,775 | `206be6e101abb471…` |
...
for m in PART.finditer(open("round22lap02FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-22-lap-02.md sha256=206be6e101abb47188e2567460c3afd65e80e7553122adad596dd9bb8d352906 >>>>>>>>>>
