...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-16-lap-16.md` | 14,032 | `18cd6588321002ac…` |
...
for m in PART.finditer(open("round16lap16FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-16-lap-16.md sha256=18cd6588321002ace694176901e6a1706bdfdf2ff7dc626bd245cd51d4515cc9 >>>>>>>>>>
