...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-09-lap-08.md` | 21,563 | `7a3b86d7316ea0f6…` |
...
for m in PART.finditer(open("round09lap08platterpus.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-09-lap-08.md sha256=7a3b86d7316ea0f6d4126620173b5d00a7b1ba9e52ab0914e2e67ec769131ab3 >>>>>>>>>>
