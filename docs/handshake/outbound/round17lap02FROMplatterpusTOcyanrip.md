...
| file | bytes | sha256 |
| --- | --- | --- |
| `round-17-lap-02.md` | 10,785 | `9fe19027bf23bb32…` |
...
for m in PART.finditer(open("round17lap02FROMplatterpusTOcyanrip.md", encoding="utf-8").read()):
    data = (m["body"] + "\n").encode("utf-8")
...
<<<<<<<<<< BEGIN round-17-lap-02.md sha256=9fe19027bf23bb32b78d7d5736633b950f27f015165ff10d940a8282145c45a9 >>>>>>>>>>
...
**`62d9645`**, resolved by `our_pin()` from the commit that introduces
