...
SENT_LAPS: dict[str, str] = {
    ...
    # Round 27 lap 2: OPEN — moves PIN_UNDER_REVIEW to 221a1df, names 0.6.59 as the
    # release that carries it, records the operator's §6b override for v0.6.59, and
    # corrects the round-26 "outside both programs"; released on the maintainer's
