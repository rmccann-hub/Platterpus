...
- **Still open (P2, user-requested):** the placeholder track rows are editable in the table but those edits don't yet feed the unknown-album rip's tags — see "Edited track tags feed the unknown-album rip" in TASKS.md P2.
