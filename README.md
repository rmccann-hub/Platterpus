...
> **Status: v0.6.9 — BETA, for the joint cyanrip hardware test session.** This build exists to produce the evidence the open cyanrip handshake round needs in order to close; it is **not** a jointly-verified pair, and every rip it makes says so in its own report. For ordinary use, prefer the latest stable v0.6.x release.
>
