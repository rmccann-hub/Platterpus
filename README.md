...
> **stock cyanrip 0.9.3.1**. Platterpus pins a *fork* — currently `2cce60d`,
> `cyanrip 0.9.4-rc2+platterpus.13`, approved by handshake round 23 — and a rip
...
cyanrip --version
# → cyanrip 0.9.4-rc2+platterpus.13 (platterpus-fork-g2cce60d)
