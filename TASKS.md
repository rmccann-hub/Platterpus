...
- **[x] Execute the 2026-07-21 docs-audit consolidation plan — COMPLETE 2026-07-21** (see [docs/audit-2026-07-21.md](docs/audit-2026-07-21.md) for the full findings + before→after map). The easy-tier fixes (~160 findings) were applied in the audit session; every captured restructure below is now executed (the parent box just lagged the last sub-item):
