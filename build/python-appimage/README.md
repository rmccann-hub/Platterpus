...
| `platterpus.desktop` | Desktop integration metadata. |
| `platterpus.png` | App icon. `build_appimage.sh` generates a placeholder if missing; replace with a real 256×256 PNG before public release. |
...
`platterpus.png` (a 512×512 CD-disc icon) is committed and used as-is by
