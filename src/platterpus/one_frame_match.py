...
up to ``+platterpus.16``, and from ``+platterpus.17`` (``cyanrip@ec0fe47:src/cyanrip_log.c:625``,
announced in their round 27 lap 4)

    Accurip 450: 57722DDE (matches Accurip DB, confidence 200, one frame only; whole-track checksums not found)
