...
class UninstallDialog(QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle("Uninstall Whipper GUI")
        self.resize(580, 480)
        ...
        intro = QLabel(
            "This removes what Whipper GUI installed on this computer:\n\n"
    ...
    def _on_uninstall_clicked(self) -> None:
        ...
        choice = QMessageBox.warning(
            self,
            "Uninstall Whipper GUI?",
            "Remove Whipper GUI and the ticked items from this computer?\n\n"
